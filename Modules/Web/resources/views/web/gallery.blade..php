...
<!-- ============ PAGE BANNER ============ -->
<section class="page-banner" style="background:linear-gradient(rgba(107,20,40,.88), rgba(20,67,47,.55)), url('https://images.unsplash.com/photo-1523240795612-9a054b0db644?w=1600&q=80') center 30%/cover;">
...
<section class="gallery-section">
    <div class="container">
        ...
        <div class="gallery-grid" id="galleryGrid">
            ...
            <div class="gallery-item" data-aos="zoom-in" data-aos-delay="{{ ($i % 6) * 80 }}" data-category="{{ $item['category'] }}">
                <a href="{{ $item['image']->file_type === 'image' ? Storage::url($item['image']->path) : '#' }}" class="gallery-lightbox" data-title="{{ $item['label'] }}">
            ...
            <div class="gallery-item" data-category="campus-life">
                <img src="https://images.unsplash.com/photo-1523050854058-8df90110c9f1?w=600&q=80" alt="Campus Life">
            </div>
