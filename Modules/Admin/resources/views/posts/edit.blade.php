...
@section('admin_content')
                ...
                <div class="card card-outline card-primary mb-3">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="code" id="codeInput" value="{{ old('code', $post->code) }}"
                        ...
                        <div class="form-group">
                            ...
                            <small class="text-muted">Changing this will change the post's public URL.</small>
                            @error('slug')
            ...
            <div class="col-md-4">
                ...
                <div class="card card-outline card-info mb-3">
                    ...
                    <div class="card-body">
                        ...
                        @if ($post->image)
                            <div class="mb-2">
                                ...
                                <div class="d-flex justify-content-between align-items-center mt-1">
                                    ...
                                    <button type="submit" form="removeImageForm" class="btn btn-xs btn-outline-danger">
                        ...
                        <small class="text-muted">JPG, PNG or WEBP. Max 4MB. Uploading replaces the current image.</small>
                        @error('image')
                            <div class="text-danger small mt-1">{{ $message }}</div>
                        @enderror
                        <div class="mt-3">
    ...
    {{-- Separate form for the remove-image button, submitted via its `form="removeImageForm"` attribute above --}}
...
@section('extra_js')
    ...
    <script>
        ...
        /* ── Live slug ── */
        var isManual = true; // in edit mode, don't auto-overwrite an existing slug on title change
