...
@section('page_title', 'Add Counter')
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.counters.store') }}" method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="font-weight-bold">Number <span class="text-danger">*</span></label>
                                    <input type="text" name="number" value="{{ old('number') }}"
                                        class="form-control @error('number') is-invalid @enderror" placeholder="e.g. 500"
                                        oninput="updatePreview()">

                                    <small class="text-muted">Only number value</small>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="prefix" value="{{ old('prefix') }}" class="form-control"
                                        placeholder="e.g. $" oninput="updatePreview()">
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="p-3 text-center rounded"
                                        ...
                                        <iconify-icon id="iconPreview" icon="mdi:help-circle" width="40"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="icon" id="iconInput" value="{{ old('icon') }}"
                                        class="form-control" placeholder="e.g. mdi:account-group" oninput="updatePreview()">

                                    <small class="text-muted">
                                        Example: mdi:account-group, lucide:users
                                    </small>

                                    <div class="mt-2">
                                        <iconify-icon id="iconPreviewSmall" icon="mdi:help-circle" width="30"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="description" value="{{ old('description') }}"
                                        class="form-control" placeholder="e.g. And growing every day">
                                </div>
                            </div>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="color" name="color" value="{{ old('color', '#4f46e5') }}"
                                        class="form-control" style="height:38px;" oninput="updatePreview()">
                                </div>
                            </div>
